...
// Esempio di utilizzo della classe FirstUser
/* const user1 = new FirstUser(10);
console.log("🚀 ~ file: script.ts:46 ~ user1:", user1)
user1.ricarica(10);
user1.chiamata(5); // Effettua una chiamata di 5 minuti
console.log("Saldo residuo:", user1.saldoResiduo);
console.log("Numero di chiamate effettuate:", user1.getNumeroChiamate);
user1.azzeraChiamate();


let body = <HTMLBodyElement>document.querySelector('body');
console.log("🚀 ~ file: script.ts:62 ~ body:", body)
