...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (starWarsCharacters[i].eye_color) { /* fra le parentesi metto dove devo andare cercare  */
    case "blue":
      eyeColors.blue.push(starWarsCharacters[i]);
      break; 
    case "yellow":
      eyeColors.yellow.push(starWarsCharacters[i]);
      break;
    case "brown":
      eyeColors.brown.push(starWarsCharacters[i]);
      break;
    case "red":
      eyeColors.red.push(starWarsCharacters[i]);
      break;
    case "blue-gray":
      eyeColors.blueGray.push(starWarsCharacters[i]);
      break;
    default: console.log("Eye color: not found");
}
}
console.log(eyeColors);
/* ESERCIZIO 6
...
while (h < starWarsCharacters.length) {
  massTotal += parseInt(starWarsCharacters[h].mass);
  h++;
}
console.log(massTotal); /* il risultato fa una somma di stringhe, non di numeri */
