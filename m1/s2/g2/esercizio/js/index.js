...
content.innerHTML = "<h2 id=\"exercise\">Rispondi alle seguenti domande:</h2>\n<ol start=\"1\" id=\"questions\"><li id=\"question1\"></li><li id=\"question2\"></li><li id=\"question3\"></li><li id=\"question4\"></li><li id=\"question5\"></li><li id=\"question6\"></li><li id=\"question7\"></li></ol>"; 
...
*/
let question_1 = document.getElementById('question1');
let question_2 = document.getElementById('question2');
let question_3 = document.getElementById('question3');
let question_4 = document.getElementById('question4');
let question_5 = document.getElementById('question5');
let question_6 = document.getElementById('question6');
let question_7 = document.getElementById('question7');
