...
console.log(splitMe("ciao mi chiamo alessandro"));
...
console.log(deleteOne("ciao mi chiamo alessandro", true));
console.log(deleteOne("ciao mi chiamo alessandro", false));
...
function isThisAnEmail(email) {
  let control = /^[A-z0-9\.\+_-]+@[A-z0-9\._-]+\.[A-z]{2,6}$/;
  let validity = control.test(email);
  return validity;
}
...
console.log(howManyDays('2023-03-27')); 
...
function isTodayMyBirthday(birthMonth, birthDay) {
  let today = new Date();
  let result = today.getMonth() +1 === birthMonth && today.getDate() === birthDay;
  return result;
}

console.log(isTodayMyBirthday(1, 27));
...
function textInTd() {
  ...
  for (i=0; i < allTd.length; i++){ 
    let tdContent = allTd[i].textContent;
...
// QUESTO NEL CASO IN CUI LA CONSEGNA INTENDESSE DI RIMUOVERE I <li> SENZA RIMUOVERE ANCHE <ul>
function clearUl() {
  let unorderedList = document.querySelector('#myList')
...
// QUESTO NEL CASO IN CUI LA CONSEGNA INTENDESSE DI RIMUOVERE <ul> CON TUTTO IL CONTENUTO
function deleteUl() {
  let unorderedList = document.querySelector('#myList')
